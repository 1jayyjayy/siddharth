...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "DIVIDUAL",
    year: "2026",
    kind: "COLLABORATIVE INTERACTIVE INSTALLATION",
    partner: "TINDERBOX COLLECTIVE × RAY INTERACTIVE",
    group: "featured",
    tags: [
    ...
    summary:
      "An interactive installation developed through Tinderbox Collective’s Room to Play programme, imagining the public showroom of a playful but increasingly sinister technology corporation.",
    description: [
      "An interactive installation developed through Tinderbox Collective’s Room to Play programme, imagining the public showroom of a playful but increasingly sinister technology corporation.",
      "I contributed interactive digital narratives, networked camera systems, responsive soundscapes and live magical encounters—exploring how technology can watch, address and persuade the people using it.",
    ],
