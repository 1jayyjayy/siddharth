...
export const site = {
  ...
  email: "siddharth@example.ac.uk",
  socials: [
    { label: "Email", value: "siddharth@example.ac.uk", href: "mailto:siddharth@example.ac.uk", kind: "channel" },
    { label: "Instagram — performance archive", value: "@sid.biswas", href: "https://instagram.com", kind: "instrument" },
